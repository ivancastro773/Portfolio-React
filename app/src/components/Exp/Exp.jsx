        ...
        {experience.map((item, i) => {
          return (
            ...
            >
              ...
              <h2 className="">
                {item.title}
                {item.title == "Dispo-Deportes SR" ? (
                  <Tooltip title="Trabajo Final de la carrera" placement="top" color="orange">
                  <span><i class="certificate tooltiptext fas fa-medal"></i></span>
                  </Tooltip>
                ) : (
                  ""
                )}{" "}
              ...
              {item.work == "team" ? (
                <Tooltip title="En Equipo" placement="bottom" color="blue">
                  <p>
                    <i class="fas fa-users fa-2x"></i>
                  </p>
                </Tooltip>
              ) : (
                <Tooltip title="Individual" placement="bottom" color="blue">
                  <p>
